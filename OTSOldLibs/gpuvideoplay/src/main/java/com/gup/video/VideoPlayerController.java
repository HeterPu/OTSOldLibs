...
//            mBottom.setVisibility(INVISIBLE);
    ...
    public void setControllerState(int playState, int windowState) {
        ...
        switch (playState) {
            case GLMediaPlayerWrapper.STATE_IDLE:
                ...
                Log.e("mCurrentState","STATE_IDLE");
                break;
            ...
            case GLMediaPlayerWrapper.STATE_COMPLETED:
                ...
                Log.e("mCurrentState","STATE_COMPLETED");
                if (mBottom.getVisibility()==INVISIBLE){
            ...
            case GLMediaPlayerWrapper.COMPLETED_STATE_PLAYING:
                ...
                mLoading.setVisibility(GONE);
                mRestartPause.setImageResource(R.drawable.ic_player_pause);
                Log.e("mCurrentState","COMPLETED_STATE_PLAYING");
                break;
        }
    ...
    public void updateStatusToPlaying(){
        setControllerState(GLMediaPlayerWrapper.STATE_PLAYING,GLMediaPlayerWrapper.PLAYER_NORMAL);
    }
