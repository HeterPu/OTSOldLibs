...
public class GLMediaPlayerWrapper implements VideoPlayerControl {
    ...
    public void setOnVideoPlayStatusChangeListener(GLMediaPlayerWrapper.onVideoPlayStatusChangeListener onVideoPlayStatusChangeListener) {
        this.onVideoPlayStatusChangeListener = onVideoPlayStatusChangeListener;
    }

    private onVideoPlayStatusChangeListener onVideoPlayStatusChangeListener;
    ...
    private MediaPlayer.OnPreparedListener mOnPreparedListener = new MediaPlayer.OnPreparedListener() {
        ...
        public void onPrepared(MediaPlayer mp) {
            ...
            if (onVideoPlayStatusChangeListener!=null){
                onVideoPlayStatusChangeListener.onVideoPlay();
            }
        }
    };
            ...
            handler.postDelayed(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        seekTo(0);
                        if (onVideoPlayStatusChangeListener!=null){
                            onVideoPlayStatusChangeListener.onVideoPlayComplete();
                        }
        ...
        public boolean onInfo(MediaPlayer mp, int what, int extra) {
            if (what == MediaPlayer.MEDIA_INFO_VIDEO_RENDERING_START) {
                ...
                if (mCurrentState == STATE_PAUSED || mCurrentState == STATE_BUFFERING_PAUSED) {
                    ...
                    updateVideoPlayerState();
                    if (onVideoPlayStatusChangeListener!=null){
                        onVideoPlayStatusChangeListener.onVideoPause();
                    }
                } else {
